...
def print_opt_results(results):    
    ...
    par_df = pd.DataFrame(par_list, columns = ['target_profit','bpl', 'bpl_perc', 'bpd', 'bpd_perc', 'hours_to_expirate','profit', 'sharpe'])
    print(par_df.sort_values(by=['profit', 'sharpe'], ascending=False))
